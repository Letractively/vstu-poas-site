...
class Admin extends CI_Controller {
	...
	*/
    ...
    {
        $this->_show_admin_page('publication', 'publications', 'publication_model_2');
...
//                {
//                    $this->form_validation->set_error_delimiters('<div class="error">', '</div>');
//                    if ($this->form_validation->run('admin/publications') == FALSE)
//                    {
//                        $data['content'] = $this->load->view('admin/edit_publication_view', $data, TRUE);
//                        $data['title'] = $this->lang->line('creatingnew') . ' ' . $this->lang->line('publication_a');
//                        $this->load->view('/templates/admin_view', $data);
//                    }
//                    else
//                    {
//                        $this->{MODEL_PUBLICATION}->add_from_post();
//                        $this->_view_page_list('publications', MODEL_PUBLICATION, $this->{MODEL_PUBLICATION}->message);
//                    }
//                }
//                else
//                {
...
//                    {
//                        //$data['extra'] = $this->{MODEL_PROJECT}->get_view_extra();
//                        $data['publication'] = $this->{MODEL_PUBLICATION}->get_from_post();
//                        $data['content'] = $this->load->view('admin/edit_publication_view', $data, TRUE);
//                        $data['title'] = $this->lang->line('changing') . ' ' . $this->lang->line('publication_a');
//                        $this->load->view('/templates/admin_view', $data);
//                    }
//                    else
//                    {
//                        $this->{MODEL_PUBLICATION}->edit_from_post();
//                        $this->_view_page_list('publications', MODEL_PUBLICATION, $this->{MODEL_PUBLICATION}->message);
//                    }
//                }
//                else
//                {
//                    if (!$this->{MODEL_PUBLICATION}->exists($this->uri->segment(4)))
//                    {
//                        $this->_view_page_list('publications', MODEL_PUBLICATION, 'Публикация не существует');
//                        return;
//                    }
//                    // загрузить необходимые виду данные
//                    //$data['extra'] = $this->{MODEL_DIRECTION}->get_view_extra();
//                    $data['publication'] = $this->{MODEL_PUBLICATION}->get_publication($this->uri->segment(4));
//                    $data['content'] = $this->load->view('/admin/edit_publication_view', $data, TRUE);
//                    $data['title'] = $this->lang->line('changing') . ' ' . $this->lang->line('publication_a');
//                    $this->load->view('/templates/admin_view', $data);
//                }
...
//                    return;
//                }
//				$this->{MODEL_PUBLICATION}->delete($this->uri->segment(4));
//                $this->_view_page_list('publications', MODEL_PUBLICATION, $this->{MODEL_PUBLICATION}->message);
//				break;
//			case '':
//			default:
//				// по адресу "/admin/$name": список всех
//				// он же при несуществующем методе
//				$this->_view_page_list('publications', MODEL_PUBLICATION);
//				break;
//		}
    }
